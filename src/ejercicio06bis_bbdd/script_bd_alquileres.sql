...
CREATE TABLE alquiler(
    ...
    PRIMARY KEY (id),
    CONSTRAINT matricula_vehiculo FOREIGN KEY(vehiculo) REFERENCES vehiculo(matricula)

);


INSERT INTO vehiculo VALUES ('1111TTT','Volvo XC60',0,false,null,30,'turismo');
INSERT INTO vehiculo VALUES ('2222TTT','Audi A4',0,false,null,30,'turismo');
INSERT INTO vehiculo VALUES ('3333FFF','Citroen C16',0,false,0.5,null,'furgoneta');
